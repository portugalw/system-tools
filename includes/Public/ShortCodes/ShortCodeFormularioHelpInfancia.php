...
namespace SystemToolsHelpInfancia\Public\ShortCodes;

class ShortCodeFormularioHelpInfancia
{
   ...
   public function create_embed_helpinfancia_form_with_email($atts)
   {
